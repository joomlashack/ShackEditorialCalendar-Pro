...
class PixPublishfreeViewPanel extends JViewLegacy
{
    ...
    public function display($tpl = null)
    {
        ...
        $doc->addScript(JUri::root() . 'administrator/components/com_pixpublishfree/media/lib/fullcalendar/fullcalendar.min.js',
            'text/javascript');
        ...
        JFactory::getDocument()
            ->addScriptDeclaration('PLUGIN["contentfree"] = "' . JText::_('PLG_PIXPUBLISHFREE_CONTENT_TYPE_NAME') . '";');
